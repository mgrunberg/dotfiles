...
plugins=(git git-prompt zsh-syntax-highlighting history-substring-search ng web-search common-aliases zsh-completions copyfile history fnm z zsh-autosuggestions sudo)
